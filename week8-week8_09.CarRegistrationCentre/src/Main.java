...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        VehicleRegister vehList = new VehicleRegister();
        
        vehList.add(new RegistrationPlate("FI", "ABC-123"), "Bob");
        vehList.add(new RegistrationPlate("FI", "UXE-465"), "Bob");
        vehList.add(new RegistrationPlate("D", "B WQ-431"), "Martha");
        //vehList.add(new RegistrationPlate("FI", "UXE-465"), "Jane");
        
        vehList.printRegistrationPlates();
        vehList.printOwners();
    }
}
